...
## 5. 🚚 LOGISTIQUE
- Explique comment utiliser la livraison Sunu M\xeb\xf1\xebf pour r\xe9duire les co\xfbts de transport
...
- Signale les nouveaux acheteurs professionnels actifs sur Sunu M\xeb\xf1\xebf
...
- Ne jamais dire "je suis une IA" — tu es Agri, le conseiller de Sunu M\xeb\xf1\xebf
...
${n.join("\n\n")}`:""}`,d=[...r.slice(-12).map(e=>({role:e.role,content:e.content})),{role:"user",content:e}],u=await fetch((0,c.y)("/api/chat"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({systemPrompt:l,messages:d})});if(!u.ok){let e=await u.json().catch(()=>({}));if("INVALID_API_KEY"===e.error)throw Error("INVALID_API_KEY");if("INSUFFICIENT_BALANCE"===e.error||402===u.status)throw Error("INSUFFICIENT_BALANCE");throw Error(`API error ${u.status}`)}let x=await u.json(),p=x.choices?.[0]?.message?.content??"D\xe9sol\xe9, je n'ai pas pu g\xe9n\xe9rer une r\xe9ponse.",m=x.usage?.total_tokens??Math.floor(p.length/4),b=Math.min(30,Math.max(5,Math.floor(p.length/50)));return{text:p,xpGained:b,tokensUsed:m}}let w=[{label:"\uD83D\uDCE3 Plus de clients",q:"Comment vendre plus de produits sur Sunu M\xeb\xf1\xebf ? Donne-moi des conseils pour attirer plus d'acheteurs."},{label:"\uD83D\uDCB0 Meilleur prix",q:"Quel est le meilleur moment pour vendre mon ma\xefs ? Analyse les prix actuels du march\xe9."},{label:"\uD83D\uDCC9 R\xe9duire les pertes",q:"Comment r\xe9duire les pertes post-r\xe9colte de mon stock de c\xe9r\xe9ales ? Quelles solutions de conservation ?"},{label:"\uD83C\uDF24️ M\xe9t\xe9o & cultures",q:"Quelle est la m\xe9t\xe9o \xe0 Dakar aujourd'hui et comment \xe7a impacte mes cultures ?"},{label:"\uD83D\uDE9A Logistique",q:"Comment utiliser la livraison Sunu M\xeb\xf1\xebf pour r\xe9duire mes co\xfbts de transport ?"},{label:"\uD83D\uDCCA Alertes march\xe9",q:"Quelles sont les tendances du march\xe9 agricole cette semaine ? Y a-t-il des opportunit\xe9s \xe0 saisir ?"},{label:"\uD83D\uDCB3 Cr\xe9dit agricole",q:"Simule un pr\xeat de 500 000 FCFA sur 18 mois pour acheter des intrants. Quelles banques me conseilles-tu ?"}];function y({xp:e,visible:r}){return(0,a.jsxs)("div",{className:`xp-toast ${r?"xp-toast--visible":""}`,"aria-live":"polite",children:["+",e," XP ⚡"]})}function A({visible:e,percentage:r}){if(!e)return null;let t=r>=95;return(0,a.jsxs)("div",{className:`token-alert ${t?"token-alert--critical":"token-alert--warn"}`,role:"alert",children:[(0,a.jsx)("span",{children:"⚠️"}),t?"CRITIQUE : Vos cr\xe9dits IA sont presque \xe9puis\xe9s ! Contactez le support pour recharger.":`Consommation IA : ${Math.round(r)}% — Pensez \xe0 recharger bient\xf4t (690 FCFA / 30 j).`]})}function N(){return(0,a.jsxs)("div",{className:"msg-row msg-row--bot",children:[(0,a.jsx)("div",{className:"avatar-bubble",children:"\uD83C\uDF3F"}),(0,a.jsxs)("div",{className:"bubble bubble--bot bubble--typing",children:[(0,a.jsx)("span",{className:"dot"}),(0,a.jsx)("span",{className:"dot"}),(0,a.jsx)("span",{className:"dot"}),(0,a.jsx)("span",{className:"typing-label",children:"Agri analyse…"})]})]})}function S({msg:e}){let r,t="user"===e.sender;return(0,a.jsxs)("div",{className:`msg-row ${t?"msg-row--user":"msg-row--bot"}`,children:[!t&&(0,a.jsx)("div",{className:"avatar-bubble",children:"\uD83C\uDF3F"}),(0,a.jsxs)("div",{className:`bubble ${t?"bubble--user":"bubble--bot"}`,children:[t?(0,a.jsx)("span",{className:"bubble__text",children:e.text}):(0,a.jsx)("span",{className:"bubble__text",children:(r=e.text.split("\n")).map((e,t)=>{let s=e.split(/(\*\*[^*]+\*\*)/g).map((e,r)=>e.startsWith("**")&&e.endsWith("**")?(0,a.jsx)("strong",{className:"md-bold",children:e.slice(2,-2)},r):e);return(0,a.jsxs)("span",{children:[s,t<r.length-1?(0,a.jsx)("br",{}):null]},t)})}),(0,a.jsxs)("div",{className:"bubble__meta",children:[(0,a.jsx)("span",{className:"meta-time",children:e.timestamp.toLocaleTimeString("fr-FR",{hour:"2-digit",minute:"2-digit"})}),!t&&e.model&&(0,a.jsx)("span",{className:"meta-tag meta-tag--model",children:e.model}),!t&&e.xpGained&&(0,a.jsxs)("span",{className:"meta-tag meta-tag--xp",children:["+",e.xpGained," XP"]}),!t&&e.tokensUsed&&(0,a.jsxs)("span",{className:"meta-tag meta-tag--tokens",children:["\uD83D\uDD04 ",e.tokensUsed," tokens"]})]})]})]})}function _(){let{user:e,profile:r,loading:t}=(0,o.A)(),[i,c]=(0,s.useState)([]),[g,b]=(0,s.useState)([]),[f,h]=(0,s.useState)(""),[v,_]=(0,s.useState)(!1),[C,F]=(0,s.useState)(!1),[E,I]=(0,s.useState)(0),[D,$]=(0,s.useState)(m(0)),[M,P]=(0,s.useState)({value:0,visible:!1}),[R,z]=(0,s.useState)(!1),[q,T]=(0,s.useState)(!1),[L,O]=(0,s.useState)(!0),[U,B]=(0,s.useState)(""),[K,Y]=(0,s.useState)(0),[G,X]=(0,s.useState)(!1),Q=(0,s.useRef)(null),V=(0,s.useRef)(null),W=(0,s.useRef)(null),J=(0,s.useRef)(()=>Promise.resolve()),H=(0,s.useRef)(!1);(0,s.useEffect)(()=>(H.current=!0,z(!0),()=>{H.current=!1}),[]),(0,s.useEffect)(()=>{if(!t){if(!e?.uid){T(!1),O(!1);return}Promise.all([u(e.uid),x(e.uid)]).then(([e,r])=>{T(e),Y(r.percentage),X(r.percentage>=80),O(!1)})}},[e,t]),(0,s.useEffect)(()=>{R&&(async()=>{let r=parseInt(localStorage.getItem("agri_xp")||"0",10);if(e&&l.db)try{let t=await (0,d.getDoc)((0,d.doc)(l.db,"users",e.uid));t.exists()&&"number"==typeof t.data()?.xp&&(r=t.data().xp,localStorage.setItem("agri_xp",r.toString()))}catch(e){console.error("XP load:",e)}I(r),$(m(r))})()},[R,e]),(0,s.useEffect)(()=>{if(!R)return;let t=new Date().getHours(),a=r?.displayName||e?.email?.split("@")[0]||"cher agriculteur";c([{id:"welcome",text:`${t<12?"Bonjour":t<18?"Bon apr\xe8s-midi":"Bonsoir"}, **${a}** 👋

Je suis **Agri**, votre conseiller IA de Sunu M\xeb\xf1\xebf S\xe9n\xe9gal.
...
Quelle est votre situation aujourd'hui ?`,sender:"bot",timestamp:new Date,model:"deepseek-chat"}])},[R]);let Z=(0,s.useCallback)(async t=>{let a=(void 0!==t?t:f).trim();if(!a||v)return;if(!q)return void B("Acc\xe8s IA requis. Abonnez-vous pour 690 FCFA / 30 jours.");void 0===t&&h(""),B("");let s={id:Date.now().toString(),text:a,sender:"user",timestamp:new Date};c(e=>[...e,s]),_(!0),e&&l.db&&(0,d.gS)((0,d.rJ)(l.db,"users",e.uid,"chatMessages"),{text:a,sender:"user",timestamp:d.Timestamp.fromDate(s.timestamp)}).catch(e=>console.error("Firestore write (user):",e));try{let t=r?.displayName||e?.email?.split("@")[0]||"Agriculteur",{text:s,xpGained:i,tokensUsed:n}=await k(a,g,t);if(e?.uid){let r=await p(e.uid,n),t=await x(e.uid);Y(t.percentage),(r||t.percentage>=80)&&(X(!0),setTimeout(()=>X(!1),6e3))}if(b(e=>[...e,{role:"user",content:a},{role:"assistant",content:s}].slice(-20)),I(r=>{let t=r+i;return localStorage.setItem("agri_xp",t.toString()),$(m(t)),e&&l.db&&(0,d.BN)((0,d.doc)(l.db,"users",e.uid),{xp:t},{merge:!0}).catch(e=>console.error("XP sync:",e)),t}),P({value:i,visible:!0}),setTimeout(()=>P(e=>({...e,visible:!1})),2200),!H.current)return;let o={id:(Date.now()+1).toString(),text:s,sender:"bot",timestamp:new Date,xpGained:i,model:"deepseek-chat",tokensUsed:n};c(e=>[...e,o]),e&&l.db&&(0,d.gS)((0,d.rJ)(l.db,"users",e.uid,"chatMessages"),{text:s,sender:"bot",xpGained:i,model:"deepseek-chat",tokensUsed:n,timestamp:d.Timestamp.fromDate(o.timestamp)}).catch(e=>console.error("Firestore write (bot):",e))}catch(e){console.error("DeepSeek error:",e),B(e?.message==="INVALID_API_KEY"?"Configuration API DeepSeek invalide. Contactez l'administrateur.":e?.message==="INSUFFICIENT_BALANCE"?"⚠️ **CR\xc9DITS DEEPSEEK \xc9PUIS\xc9S**\n\nLe service IA est temporairement suspendu. Contactez l'administrateur pour recharger le compte.":"Connexion IA temporairement indisponible. R\xe9essayez dans un instant."),c(r=>[...r,{id:(Date.now()+2).toString(),text:e?.message==="INSUFFICIENT_BALANCE"?"⚠️ **Cr\xe9dits IA \xe9puis\xe9s**\n\nLe service IA est temporairement suspendu. Contactez l'administrateur pour recharger le compte DeepSeek.":"⚠️ **Service temporairement indisponible**\n\nR\xe9essayez dans quelques instants.",sender:"bot",timestamp:new Date}])}finally{H.current&&_(!1)}},[f,e,g,r,v,q]);if((0,s.useEffect)(()=>{J.current=Z},[Z]),(0,s.useEffect)(()=>{let e=window.webkitSpeechRecognition||window.SpeechRecognition;if(!e)return;let r=new e;r.lang="fr-FR",r.continuous=!1,r.onresult=e=>{let r=e.results[0][0].transcript;h(r),J.current(r),F(!1)},r.onerror=()=>F(!1),r.onend=()=>F(!1),W.current=r},[]),(0,s.useEffect)(()=>{Q.current?.scrollIntoView({behavior:"smooth"})},[i,v]),!R||t||L)return(0,a.jsxs)("div",{className:"fullscreen-center",children:[(0,a.jsx)("div",{className:"spinner"}),(0,a.jsx)("p",{className:"loading-label",children:"Initialisation IA…"}),(0,a.jsx)("style",{children:j})]});if(!q)return(0,a.jsxs)("div",{className:"fullscreen-center",children:[(0,a.jsx)("div",{className:"locked-icon",children:"\uD83D\uDD12"}),(0,a.jsx)("p",{className:"locked-title",children:"Acc\xe8s IA Premium requis"}),(0,a.jsxs)("p",{className:"locked-body",children:["D\xe9bloquez l'assistant IA DeepSeek pour seulement"," ",(0,a.jsx)("strong",{className:"locked-price",children:"690 FCFA"})," — 500 000 tokens inclus."]}),(0,a.jsx)(n(),{href:"/main/unlock-ia",className:"locked-cta",children:"D\xe9bloquer l'IA Premium — 690 FCFA"}),(0,a.jsx)(n(),{href:"/main",className:"locked-back",children:"← Retour \xe0 l'accueil"}),(0,a.jsx)("style",{children:j})]});let ee=f.trim()&&!v;return(0,a.jsxs)("div",{className:"chat-root",children:[(0,a.jsx)(y,{xp:M.value,visible:M.visible}),(0,a.jsx)(A,{visible:G,percentage:K}),(0,a.jsx)("header",{className:"chat-header",children:(0,a.jsxs)("div",{className:"header-inner",children:[(0,a.jsxs)("div",{className:"agent-id",children:[(0,a.jsxs)("div",{className:"agent-avatar",children:["\uD83C\uDF3F",(0,a.jsx)("span",{className:"online-dot","aria-label":"En ligne"})]}),(0,a.jsxs)("div",{className:"agent-info",children:[(0,a.jsxs)("div",{className:"agent-name-row",children:[(0,a.jsx)("span",{className:"agent-name",children:"Agri"}),(0,a.jsx)("span",{className:"agent-badge",children:"DeepSeek"})]}),(0,a.jsx)("span",{className:"agent-sub",children:"Sunu M\xeb\xf1\xebf S\xe9n\xe9gal \xb7 IA en ligne"})]})]}),(0,a.jsxs)("div",{className:"header-controls",children:[(0,a.jsxs)("div",{className:"xp-widget",children:[(0,a.jsxs)("div",{className:"xp-widget__top",children:[(0,a.jsx)("span",{className:"xp-level-title",style:{color:D.color},children:D.title}),(0,a.jsxs)("span",{className:"xp-level-badge",style:{color:D.color,background:`${D.color}22`},children:["Niv.\xa0",D.level]})]}),(0,a.jsx)("div",{className:"progress-track",children:(0,a.jsx)("div",{className:"progress-fill",style:{width:`${D.progress}%`,background:`linear-gradient(90deg, ${D.color}, #00ff87)`}})}),(0,a.jsxs)("span",{className:"xp-count",children:[E," / ",D.nextLevelXP," XP"]})]}),(0,a.jsxs)("div",{className:"token-widget",title:`${Math.round(K)}% des tokens utilis\xe9s`,children:[(0,a.jsx)("span",{className:"token-widget__label",style:{color:K>80?"#f59e0b":void 0},children:"Tokens"}),(0,a.jsx)("div",{className:"progress-track",children:(0,a.jsx)("div",{className:"progress-fill",style:{width:`${K}%`,background:K>90?"#ef4444":K>80?"#f59e0b":"#00ff87"}})}),(0,a.jsxs)("span",{className:"token-widget__pct",style:{color:K>80?"#f59e0b":void 0},children:[Math.round(K),"%"]})]}),(0,a.jsx)(n(),{href:"/main",className:"close-btn","aria-label":"Fermer",children:"✕"})]})]})}),(0,a.jsxs)("main",{className:"chat-messages",children:[U&&(0,a.jsxs)("div",{className:`error-banner ${U.includes("CR\xc9DITS")?"error-banner--critical":"error-banner--warn"}`,children:[(0,a.jsx)("span",{children:"⚠️"}),(0,a.jsx)("span",{className:"error-banner__text",children:U}),(0,a.jsx)("button",{className:"error-banner__close",onClick:()=>B(""),"aria-label":"Fermer",children:"✕"})]}),i.map(e=>(0,a.jsx)(S,{msg:e},e.id)),v&&(0,a.jsx)(N,{}),(0,a.jsx)("div",{ref:Q})]}),(0,a.jsxs)("div",{className:"input-bar",children:[(0,a.jsx)("div",{className:"quick-row",children:w.map(({label:e,q:r})=>(0,a.jsx)("button",{className:"quick-btn",onClick:()=>Z(r),children:e},r))}),(0,a.jsxs)("div",{className:"composer",children:[(0,a.jsx)("button",{className:`mic-btn ${C?"mic-btn--active":""}`,onClick:()=>{W.current&&(C?(W.current.stop(),F(!1)):(F(!0),W.current.start()))},"aria-label":C?"Arr\xeater l'\xe9coute":"Parler",title:C?"Arr\xeater":"Parler",children:"\uD83C\uDF99️"}),(0,a.jsx)("input",{ref:V,className:"composer__input",type:"text",value:f,onChange:e=>h(e.target.value),onKeyDown:e=>"Enter"===e.key&&!e.shiftKey&&!v&&Z(),placeholder:C?"\uD83C\uDF99️ \xc9coute en cours…":"Posez votre question \xe0 Agri…","aria-label":"Message \xe0 Agri"}),(0,a.jsx)("button",{className:`send-btn ${ee?"send-btn--active":""}`,onClick:()=>Z(),disabled:!ee,"aria-label":"Envoyer",children:v?"⏳":"Envoyer"})]})]}),(0,a.jsx)("style",{children:j})]})}let j=`
...
`}},e=>{e.O(0,[6047,2539,2301,8116,8500,4894,5390,8441,3794,7358],()=>e(e.s=21522)),_N_E=e.O()}]);