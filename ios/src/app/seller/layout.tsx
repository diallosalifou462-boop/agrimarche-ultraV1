...
// ✅ FIX : la cloche de notifications (avis, nouvelles commandes...) n'était
// montée nulle part dans l'espace vendeur — elle n'existait que sur
// main/products/page.tsx. Les notifications étaient bien créées en base
// (userId = sellerId), mais le vendeur n'avait aucun endroit pour les voir.
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <NotificationBell
                triggerClassName="relative p-2.5 rounded-xl bg-white/10 hover:bg-white/20 transition"
