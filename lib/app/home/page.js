    ...
    return (<div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-green-700 via-green-600 to-emerald-500 text-white px-4 py-16 sm:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <link_1.default href="/auth/register" className="bg-white text-green-700 font-bold px-8 py-4 rounded-2xl hover:bg-green-50 transition text-base shadow-lg">
              Commencer gratuitement →
            </link_1.default>
            <link_1.default href="/auth/login" className="border-2 border-white/50 text-white font-semibold px-8 py-4 rounded-2xl hover:bg-white/10 transition text-base">
              Se connecter
            </link_1.default>
          </div>
        </div>
        ...
        <div className="mt-12 flex gap-3 overflow-x-auto pb-2 max-w-2xl mx-auto justify-center flex-wrap">
          {HERO_ITEMS.map((item) => (<div key={item.label} className="flex-shrink-0 bg-white/20 backdrop-blur rounded-xl px-4 py-2 flex items-center gap-2">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map((f) => (<div key={f.title} className="text-center p-6 rounded-2xl bg-gray-50 hover:bg-green-50 transition">
      ...
      <section className="bg-green-50 border-y border-green-100 px-4 py-14">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <link_1.default href="/auth/register" className="inline-block bg-green-600 hover:bg-green-700 text-white font-bold px-8 py-4 rounded-2xl transition">
            Devenir vendeur →
          </link_1.default>
        </div>
      </section>
