...
function SplashPage() {
    ...
    return (<div className="relative min-h-screen bg-gradient-to-br from-white via-green-50 to-emerald-100 flex flex-col items-center justify-center p-6 overflow-hidden">

      {/* BACKGROUND */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">

        <div className="absolute w-[500px] h-[500px] rounded-full border border-green-200/30 animate-ping" style={{
      ...
      <div className="relative z-10 transition-all duration-700">
        ...
        <div className="relative group">
          ...
          <image_1.default src="/logo.png" alt="Agrimarché" width={240} height={240} priority className="relative z-10 drop-shadow-2xl transition-transform duration-500 group-hover:scale-105"/>
      ...
      <div className="relative z-10 mt-12 w-64">
        ...
        <div className="relative h-1.5 bg-gray-200/60 rounded-full overflow-hidden backdrop-blur-sm">
          ...
          <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-green-500 via-emerald-400 to-green-600 rounded-full transition-all duration-100 ease-out" style={{
            width: `${progress}%`,
        }}>
      ...
      <div className="relative z-10 mt-6 flex gap-3">
        ...
        {[0, 1, 2].map((i) => (<div key={i} className="w-2.5 h-2.5 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 animate-bounce" style={{
      ...
      <div className="absolute bottom-6 left-0 right-0 text-center">
        ...
        <p className="text-xs text-gray-400 tracking-wide">
          ...
          © {new Date().getFullYear()} Agrimarché — v2.0
