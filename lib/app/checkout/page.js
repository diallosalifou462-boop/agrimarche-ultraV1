...
const useUserLocation_1 = require("@/hooks/useUserLocation");
...
const PAYMENT_METHODS_CONFIG = {
    wave: {
        ...
        icon: <lucide_react_1.Smartphone size={17}/>,
        fee: 0,
        paymentLink: (amount) => {
...
───────────────────────────────────────────── */
function PaymentModal({ method, amount, onConfirm, onBack }) {
    ...
    return (<div className="modal-card" style={{ maxWidth: 460 }}>
        ...
        {method.id === 'wave' ? (<>
            <div style={{ background: 'var(--ivory)', borderRadius: 12, padding: '20px', textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, marginTop: 16 }}>
                <lucide_react_1.Shield size={16} style={{ color: 'var(--gold)' }}/>
...
function CheckoutPage() {
    ...
    const { cart, clearCart } = (0, useCart_1.useCart)();
    const { location, loading: locationLoading, detectLocation } = (0, useUserLocation_1.useUserLocation)();
    const [loading, setLoading] = (0, react_1.useState)(false);
    const [success, setSuccess] = (0, react_1.useState)(false);
    const [orderId, setOrderId] = (0, react_1.useState)('');
    const [selectedPaymentMethod, setSelectedPaymentMethod] = (0, react_1.useState)('wave');
    const [showPaymentModal, setShowPaymentModal] = (0, react_1.useState)(false);
    const [activePaymentMethod, setActivePaymentMethod] = (0, react_1.useState)(null);
    const [isProcessing, setIsProcessing] = (0, react_1.useState)(false);
    const [orderError, setOrderError] = (0, react_1.useState)('');
    const cartItems = (0, react_1.useMemo)(() => (cart === null || cart === void 0 ? void 0 : cart.items) || [], [cart]);
    const subtotal = (0, react_1.useMemo)(() => (cart === null || cart === void 0 ? void 0 : cart.total) || 0, [cart]);
    const isFreeDelivery = subtotal >= 5000;
    const deliveryFee = (0, react_1.useMemo)(() => {
        if (isFreeDelivery)
            return 0;
    ...
    const estimatedDelivery = (0, react_1.useMemo)(() => {
        if (isFreeDelivery)
            return '24 – 48 h (Express)';
        if (!(location === null || location === void 0 ? void 0 : location.lat) || !(location === null || location === void 0 ? void 0 : location.lng))
            return 'À confirmer';
        const dist = Math.sqrt(Math.pow(location.lat - 14.7167, 2) + Math.pow(location.lng + 17.4677, 2)) * 111;
        if (dist <= 10)
    ...
    const generateOrderNumber = (0, react_1.useCallback)(() => {
        const d = new Date();
    ...
    const createOrder = async () => {
        ...
        try {
            ...
            const safeSellerId = ((_a = firstItem === null || firstItem === void 0 ? void 0 : firstItem.product) === null || _a === void 0 ? void 0 : _a.sellerId) || (user === null || user === void 0 ? void 0 : user.uid) || 'agrimarche-official';
            const safeSellerName = ((_b = firstItem === null || firstItem === void 0 ? void 0 : firstItem.product) === null || _b === void 0 ? void 0 : _b.sellerName) || 'AgriMarché';
            const safeSellerPhone = ((_c = firstItem === null || firstItem === void 0 ? void 0 : firstItem.product) === null || _c === void 0 ? void 0 : _c.sellerPhone) || '221779747073';
            const safeSellerRegion = ((_d = firstItem === null || firstItem === void 0 ? void 0 : firstItem.product) === null || _d === void 0 ? void 0 : _d.region) || 'Dakar, Sénégal';
            ...
            if (safeSellerId && safeSellerId !== 'agrimarche-official') {
                try {
                    const sellerDoc = await (0, firestore_1.getDoc)((0, firestore_1.doc)(firebase_1.db, 'users', safeSellerId));
                    if (sellerDoc.exists()) {
                        const d = sellerDoc.data();
                        sellerLat = (d === null || d === void 0 ? void 0 : d.latitude) || (d === null || d === void 0 ? void 0 : d.lat) || 14.7167;
                        sellerLng = (d === null || d === void 0 ? void 0 : d.longitude) || (d === null || d === void 0 ? void 0 : d.lng) || -17.4677;
                        sellerAddress = (d === null || d === void 0 ? void 0 : d.address) || (d === null || d === void 0 ? void 0 : d.city) || 'Dakar, Sénégal';
                    }
                }
                catch (_f) { }
            }
            const selectedMethod = PAYMENT_METHODS_CONFIG[selectedPaymentMethod];
            const newOrder = {
                id: orderNumber, sellerId: safeSellerId, sellerName: safeSellerName,
                sellerPhone: safeSellerPhone, sellerRegion: safeSellerRegion,
                userId: (user === null || user === void 0 ? void 0 : user.uid) || 'guest-user', userName: (user === null || user === void 0 ? void 0 : user.displayName) || 'Client AgriMarché',
                userEmail: (user === null || user === void 0 ? void 0 : user.email) || '', userPhone: (user === null || user === void 0 ? void 0 : user.phoneNumber) || '',
                sellerLocation: { lat: sellerLat, lng: sellerLng, address: sellerAddress },
                customerLocation: { lat: (location === null || location === void 0 ? void 0 : location.lat) || null, lng: (location === null || location === void 0 ? void 0 : location.lng) || null, address: (location === null || location === void 0 ? void 0 : location.address) || (location === null || location === void 0 ? void 0 : location.city) || 'Adresse non détectée' },
                ...
                paymentMethod: selectedPaymentMethod, paymentMethodName: selectedMethod === null || selectedMethod === void 0 ? void 0 : selectedMethod.name,
                paymentStatus: 'en_attente_verification',
                items: cartItems.map(item => {
                    var _a, _b, _c, _d, _e, _f, _g, _h;
                    return ({
                        productId: ((_a = item === null || item === void 0 ? void 0 : item.product) === null || _a === void 0 ? void 0 : _a.id) || 'unknown', productName: ((_b = item === null || item === void 0 ? void 0 : item.product) === null || _b === void 0 ? void 0 : _b.name) || 'Produit inconnu',
                        productPrice: ((_c = item === null || item === void 0 ? void 0 : item.product) === null || _c === void 0 ? void 0 : _c.price) || 0, quantity: (item === null || item === void 0 ? void 0 : item.quantity) || 1,
                        unit: ((_d = item === null || item === void 0 ? void 0 : item.product) === null || _d === void 0 ? void 0 : _d.unit) || 'kg', total: (((_e = item === null || item === void 0 ? void 0 : item.product) === null || _e === void 0 ? void 0 : _e.price) || 0) * ((item === null || item === void 0 ? void 0 : item.quantity) || 1),
                        image: ((_g = (_f = item === null || item === void 0 ? void 0 : item.product) === null || _f === void 0 ? void 0 : _f.images) === null || _g === void 0 ? void 0 : _g[0]) || null, category: ((_h = item === null || item === void 0 ? void 0 : item.product) === null || _h === void 0 ? void 0 : _h.category) || 'Autres',
                    });
                }),
                deliveryTime: estimatedDelivery, createdAt: firestore_1.Timestamp.now(), updatedAt: new Date().toISOString(),
            };
            const docRef = await (0, firestore_1.addDoc)((0, firestore_1.collection)(firebase_1.db, 'orders'), newOrder);
            await (0, deliveryTracking_1.initDeliveryTracking)(docRef.id);
            await (0, firestore_1.updateDoc)((0, firestore_1.doc)(firebase_1.db, 'orders', docRef.id), { estimatedDelivery: firestore_1.Timestamp.fromDate((0, deliveryTracking_1.getEstimatedDeliveryDate)(new Date())) });
            for (const item of cartItems) {
                if ((_e = item === null || item === void 0 ? void 0 : item.product) === null || _e === void 0 ? void 0 : _e.id)
                    await (0, firestore_1.updateDoc)((0, firestore_1.doc)(firebase_1.db, 'products', item.product.id), { stock: (0, firestore_1.increment)(-(item.quantity || 1)) });
            }
    ...
    const handleCheckout = async () => {
        ...
        const method = PAYMENT_METHODS_CONFIG[selectedPaymentMethod];
        if (method) {
      ...
      <div className="success-root checkout-root">
        <div className="success-card animate-enter">
          <div className="success-icon-ring">
            <lucide_react_1.CheckCircle size={36} style={{ color: 'var(--gold)' }}/>
          </div>
          ...
          <div style={{ background: 'var(--ivory)', borderRadius: 16, padding: '16px 20px', border: '1px solid var(--border)', textAlign: 'left', marginBottom: 28 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
              <lucide_react_1.Truck size={14} style={{ color: 'var(--gold)' }}/>
            ...
            {isFreeDelivery && (<span className="tag tag-green" style={{ marginTop: 8 }}><lucide_react_1.Gift size={10}/> Livraison offerte</span>)}
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <link_1.default href="/account/orders" className="cta-btn" style={{ textDecoration: 'none', borderRadius: 14 }}>
              Mes commandes
            </link_1.default>
            <link_1.default href="/main/products" style={{ textDecoration: 'none', textAlign: 'center', fontSize: 12, color: 'var(--ink-lt)', letterSpacing: '0.08em', textTransform: 'uppercase', padding: '12px', display: 'block' }}>
    ...
    return (<>
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto', padding: '40px 20px' }}>
          ...
          <div className="animate-enter" style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 40 }}>
            ...
            <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 6 }}>
              <lucide_react_1.Lock size={12} style={{ color: 'var(--gold)' }}/>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 28 }} className="checkout-grid">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div className="card animate-enter delay-1">
                <div className="card-header">
                  ...
                  <lucide_react_1.Truck size={14} style={{ color: 'var(--ink-lt)' }}/>
                ...
                <div className="card-body">
                  <button className="location-btn" onClick={detectLocation}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                      <div className="icon-circle"><lucide_react_1.Navigation size={16}/></div>
            ...
            : (location === null || location === void 0 ? void 0 : location.city)
                ...
                : <p style={{ fontSize: 12, color: 'var(--ink-lt)' }}>Cliquez pour détecter automatiquement</p>}
                    ...
                    <lucide_react_1.ChevronRight size={16} style={{ color: 'var(--gold)', flexShrink: 0 }}/>
                  </button>
                  {(location === null || location === void 0 ? void 0 : location.address) && (<div style={{ marginTop: 12, padding: '12px 16px', background: 'var(--ivory)', borderRadius: 10, border: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 8 }}>
                      <lucide_react_1.MapPin size={14} style={{ color: 'var(--gold)', flexShrink: 0 }}/>
              ...
              <div className="card animate-enter delay-2">
                <div className="card-header">
                  <div className="card-header-dot"/>
                  <lucide_react_1.User size={14} style={{ color: 'var(--ink-lt)' }}/>
                  <span className="card-header-title">Informations de contact</span>
                </div>
                <div className="card-body" style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  {[
            { icon: <lucide_react_1.User size={15}/>, label: 'Nom complet', value: (user === null || user === void 0 ? void 0 : user.displayName) || 'Client AgriMarché' },
            { icon: <lucide_react_1.Mail size={15}/>, label: 'Adresse e-mail', value: (user === null || user === void 0 ? void 0 : user.email) || 'Non renseigné' },
            { icon: <lucide_react_1.Phone size={15}/>, label: 'Téléphone', value: (user === null || user === void 0 ? void 0 : user.phoneNumber) || 'À renseigner' },
        ].map((row) => (<div key={row.label} className="info-row">
              ...
              <div className="card animate-enter delay-3">
                <div className="card-header">
                  <div className="card-header-dot"/>
                  <lucide_react_1.CreditCard size={14} style={{ color: 'var(--ink-lt)' }}/>
                  <span className="card-header-title">Moyen de paiement</span>
                </div>
                <div className="card-body" style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  {Object.values(PAYMENT_METHODS_CONFIG).map((method) => (<label key={method.id} className={`pay-option${selectedPaymentMethod === method.id ? ' selected' : ''}`} onClick={() => setSelectedPaymentMethod(method.id)}>
                      ...
                      {selectedPaymentMethod === method.id && (<span className="tag tag-gold"><lucide_react_1.Check size={10}/> Sélectionné</span>)}
                    </label>))}
                </div>
              </div>
            </div>
            ...
            <div style={{ position: 'sticky', top: 24, alignSelf: 'start' }} className="animate-enter delay-4">
              <div className="card">
                <div style={{ background: 'var(--ink)', padding: '20px 28px', display: 'flex', alignItems: 'center', gap: 10 }}>
                  <lucide_react_1.ShoppingBag size={16} style={{ color: 'var(--gold)' }}/>
            ...
            return (<div key={idx} className="cart-item">
                        <div className="cart-thumb">
                          <lucide_react_1.Leaf size={18} style={{ color: '#2D7A4E' }}/>
                        </div>
                        <div style={{ flex: 1 }}>
                          <p style={{ fontSize: 13, fontWeight: 500, color: 'var(--ink)', marginBottom: 2 }}>{(_a = item === null || item === void 0 ? void 0 : item.product) === null || _a === void 0 ? void 0 : _a.name}</p>
                          <p style={{ fontSize: 11, color: 'var(--ink-lt)' }}>{item === null || item === void 0 ? void 0 : item.quantity} × {(((_b = item === null || item === void 0 ? void 0 : item.product) === null || _b === void 0 ? void 0 : _b.price) || 0).toLocaleString()} FCFA</p>
                        </div>
                        <p style={{ fontSize: 13, fontWeight: 600, color: 'var(--ink)', flexShrink: 0 }}>
                          {((((_c = item === null || item === void 0 ? void 0 : item.product) === null || _c === void 0 ? void 0 : _c.price) || 0) * ((item === null || item === void 0 ? void 0 : item.quantity) || 0)).toLocaleString()} <span style={{ fontSize: 10, color: 'var(--ink-lt)' }}>FCFA</span>
                        </p>
                      </div>);
        })}
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    ...
                    {isFreeDelivery && (<div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 12px', background: '#F0FAF4', borderRadius: 8, border: '1px solid #A8E6C0' }}>
                        <lucide_react_1.Gift size={12} style={{ color: '#1E7A44' }}/>
                  ...
                  <div style={{ marginTop: 16, padding: '12px 16px', background: 'var(--ivory)', borderRadius: 12, border: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 10 }}>
                    <lucide_react_1.Truck size={14} style={{ color: 'var(--gold)', flexShrink: 0 }}/>
                    <div>
                  ...
                  {orderError && (<div className="err-box" style={{ marginTop: 14 }}>
                      <lucide_react_1.AlertCircle size={14}/>{orderError}
                    </div>)}

                  <button onClick={handleCheckout} disabled={isProcessing || cartItems.length === 0} className="cta-btn" style={{ marginTop: 20 }}>
                    {isProcessing
            ? <><lucide_react_1.Loader2 size={16} style={{ animation: 'spin 1s linear infinite' }}/> Traitement…</>
            : <>Payer & confirmer →</>}
                  </button>

                  <div style={{ marginTop: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                    <lucide_react_1.Lock size={11} style={{ color: 'var(--ink-lt)' }}/>
      ...
      {showPaymentModal && activePaymentMethod && (<div className="modal-overlay">
          <PaymentModal method={activePaymentMethod} amount={total} onConfirm={handlePaymentConfirm} onBack={() => setShowPaymentModal(false)}/>
        </div>)}
    </>);
}
