...
function PrivacyPage() {
    return (<div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-900 pt-12 pb-8 px-5">
        <link_1.default href="/" className="inline-flex items-center gap-2 text-gray-400 hover:text-white transition-colors mb-4">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-6">
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
          <div className="flex items-center gap-3 mb-4">
            <lucide_react_1.Shield size={22} className="text-gray-700"/>
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
          <div className="flex items-center gap-3 mb-4">
            <lucide_react_1.Eye size={22} className="text-gray-700"/>
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
          <div className="flex items-center gap-3 mb-4">
            <lucide_react_1.Lock size={22} className="text-gray-700"/>
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
          <div className="flex items-center gap-3 mb-4">
            <lucide_react_1.Trash2 size={22} className="text-gray-700"/>
