...
export default function AccountPage() {
  ...
  if (!user) return null;
  const avatarInitial = getAvatarInitial(profile?.displayName || user.displayName);
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center gap-5 relative z-10">
              ...
              <div
                className="w-24 h-24 rounded-full backdrop-blur-sm flex items-center justify-center text-white text-4xl font-bold ring-4 ring-white/30 shadow-lg"
