...
export const metadata = {
  title: "Conditions d'utilisation — Sunu Mëñëf",
  description: "Conditions d'utilisation de la plateforme Sunu Mëñëf : éligibilité, responsabilités, règles de publication, limitation de responsabilité et suspension de compte.",
};
  ...
  return (
    <main style={{ maxWidth: 760, margin: '0 auto', padding: '32px 20px 80px', color: '#1f2a22', lineHeight: 1.65 }}>
      ...
      <p>
        ...
        l&apos;utilisation de la plateforme Sunu Mëñëf (le « Service »), qui met en relation des
      ...
      <h2 style={sectionTitle}>1. Qui peut utiliser Sunu Mëñëf</h2>
      <ul style={list}>
        ...
        <li>Chaque utilisateur ne peut détenir qu&apos;un seul compte par numéro de téléphone, sauf autorisation expresse de Sunu Mëñëf.</li>
        <li>Sunu Mëñëf peut demander une vérification d&apos;identité (notamment pour les vendeurs) avant d&apos;autoriser la publication de produits.</li>
        <li>Sunu Mëñëf se réserve le droit de refuser ou de limiter l&apos;accès au Service à toute personne ne respectant pas ces conditions d&apos;éligibilité.</li>
      </ul>
      ...
      <p>
        Sunu Mëñëf agit comme intermédiaire technique mettant en relation ces utilisateurs ; elle n&apos;est
      ...
      <ul style={list}>
        ...
        <li>Sunu Mëñëf peut modérer, suspendre ou supprimer toute annonce non conforme à ces règles, sans préavis si la situation l&apos;exige.</li>
      </ul>

      <h2 style={sectionTitle}>4. Limitations de responsabilité</h2>
      <ul style={list}>
        <li>Sunu Mëñëf fournit une plateforme de mise en relation et ne garantit ni la qualité, ni la conformité, ni la livraison effective des produits échangés entre utilisateurs.</li>
        <li>Sunu Mëñëf n&apos;est pas responsable des litiges entre acheteurs, vendeurs et transporteurs, ni des pertes financières, dommages directs ou indirects résultant d&apos;une transaction conclue via le Service.</li>
        <li>Le Service est fourni « en l&apos;état » et « selon disponibilité » ; Sunu Mëñëf ne garantit pas un fonctionnement ininterrompu ou exempt d&apos;erreurs (notamment pour les fonctions de géolocalisation).</li>
        <li>Dans la mesure permise par la loi sénégalaise, la responsabilité de Sunu Mëñëf envers un utilisateur est limitée aux dommages directs et prévisibles, à l&apos;exclusion de tout préjudice indirect (perte de profit, perte de récolte, etc.).</li>
        <li>Ces limitations ne s&apos;appliquent pas en cas de faute lourde ou intentionnelle de Sunu Mëñëf, ni lorsqu&apos;une disposition légale impérative l&apos;interdit.</li>
      </ul>

      <h2 style={sectionTitle}>5. Conditions de suspension d&apos;un compte</h2>
      <p>Sunu Mëñëf peut suspendre ou résilier l&apos;accès d&apos;un utilisateur au Service, temporairement ou définitivement, notamment en cas de :</p>
      <ul style={list}>
      ...
      <p>
        ...
        justifié la mesure ont été corrigés, à la discrétion de Sunu Mëñëf.
      </p>

      <h2 style={sectionTitle}>6. Modification des Conditions</h2>
      <p>
        Sunu Mëñëf peut modifier ces Conditions à tout moment pour refléter une évolution du Service ou
