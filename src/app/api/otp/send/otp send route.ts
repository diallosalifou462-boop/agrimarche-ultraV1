...
export async function POST(req: NextRequest) {
  ...
  try {
    // `purpose` distingue une inscription ('register') d'une réinitialisation
    // de mot de passe ('reset'), pour pouvoir bloquer respectivement un
    // numéro déjà inscrit ou un numéro sans compte, AVANT même d'envoyer un
    // SMS (inutile de payer Infobip pour une requête qui sera de toute façon
    // rejetée à la vérification). Optionnel pour rétrocompatibilité : si
    // absent, aucun contrôle d'existence n'est fait ici.
