...
export default function AccountPage() {
  ...
  useEffect(() => { if (!loading && !user) router.push('/auth/register?redirect=/main/account'); }, [loading, user, router]);
  ...
  if (!user) return null;
  const initial = getAvatarInitial(profile?.displayName || user.displayName);
      ...
      <div className="relative bg-gradient-to-br from-emerald-600 via-green-600 to-teal-500 pt-14 pb-20 px-5 overflow-hidden">
        ...
        <div className="relative flex items-center gap-4">
          <div className="relative shrink-0">
            <div
              className="w-16 h-16 rounded-2xl flex items-center justify-center text-white text-2xl font-black shadow-lg ring-2 ring-white/30"
