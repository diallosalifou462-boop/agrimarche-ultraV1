// ═══════════════════════════════════════════════════════════════════════
// normalizeKeyword — IDENTIQUE dans src/lib/interests/normalizeKeyword.ts
// ═══════════════════════════════════════════════════════════════════════
...
// normalise différemment ici au moment de matcher un produit restocké,
// le match échoue silencieusement. Toute modification ici doit être
// répercutée dans src/lib/interests/normalizeKeyword.ts.
//
